...
/*   Updated: 2025/07/18 10:50:10 by sel-maaq         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	is_valid_key(char *key, t_data *data)
{
	...
	{
		ft_error3("export: '", key, "': not a valid identifier\n");
		data->exit_code = 1;
		return (0);
	}
	i = 1;
